const FIREBASE_DOMAIN = 'https://personal-library-358823-default-rtdb.firebaseio.com/';
...
export async function addComment(requestData) {
  const response = await fetch(`${FIREBASE_DOMAIN}/comments/${requestData.bookId}.json`, {
    method: 'POST',
